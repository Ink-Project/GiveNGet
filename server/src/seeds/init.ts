...
export const seed = async (knex: Knex) => {
  ...
  await knex("posts").insert([
    {
      title: "First Post",
      desc: "This is my first post. Here is a PS5 if anyone needs it",
      location: "New York",
      user_id: 1,
    },
    {
      title: "Second Post",
      desc: "I am a software developer. I need to sell this laptop",
      location: "Los Angeles",
      user_id: 2,
    },
    {
      title: "Third Post",
      desc: "How do you knw youre not in the matrix!?!? #StayWoke. Also here a gift if anyone wants it",
      location: "Los Angeles",
      user_id: 2,
    },
  ]);
  ...
  await knex("images").insert([
    ...
    {
      url: "https://cdn.thewirecutter.com/wp-content/media/2023/05/sofabuyingguide-2048px-benchmademoderncream.jpg?auto=webp&quality=75&width=1024",
      post_id: 3,
    },
  ]);
